function zodiac(){
  ...
  if (birthmonth == 1&& birthday >= 20 || birthmonth == 2 && birthday <= 18
          ...
          result = ("Aquarius");
       document.getElementById("photo").src="AQUARIUS.png";
      ...
      if (birthmonth == 2&& birthday >= 19 || birthmonth == 3&& birthday <= 20){
         result = ("Pisces");
         document.getElementById("photo").src="PISCES.png";
     ...
     if (birthmonth == 3&& birthday >= 21 || birthmonth == 4 && birthday <= 19){
         result = ("Aries");
        document.getElementById("photo").src="ARIES.png";
      ...
      if (birthmonth == 4&& birthday >= 20|| birthmonth == 5 && birthday <= 20){
          result = ("Taurus");
         document.getElementById("photo").src="TAURUS.png";
      ...
      if (birthmonth == 5&& birthday >= 21 || birthmonth == 6 && birthday <= 20){
          result = ("Gemini");
         document.getElementById("photo").src="GEMINI.png";
      ...
      if (birthmonth == 6&& birthday >= 21 || birthmonth == 7&& birthday <= 22){
          result = ("Cancer");
         document.getElementById("photo").src="CANCER.png";
      ...
      if (birthmonth == 7&& birthday >= 23 || birthmonth == 8 && birthday <= 22){
          result = ("Leo");
         document.getElementById("photo").src="LEO.png";
      ...
      if (birthmonth == 8 && birthday >= 23 || birthmonth == 9 && birthday <= 22){
          result = ("Virgo");
         document.getElementById("photo").src="VIRGO.png";
      ...
      if (birthmonth == 9&& birthday >= 23 || birthmonth == 10&& birthday <= 22){
        result = ("Libra");
         document.getElementById("photo").src="LIBRA.png";
      ...
      if (birthmonth == 10 && birthday >= 23|| birthmonth == 11 && birthday <= 21){
         result = ("Scorpio");
         document.getElementById("photo").src="SCORPIO.png";
      ...
      if (birthmonth == 11 && birthday >= 22 || birthmonth == 12 && birthday <= 21){
          result = ("Sagittarius");
         document.getElementById("photo").src="SAGITTARIUS.png";
    ...
    if(birthmonth == 12 && birthday >= 22 || birthmonth == 1 && birthday <= 19){
          ...
          result = ("Capricorn");
         document.getElementById("photo").src="CAPRICORN.png";
